...
public class Question implements Serializable {
	...
	private Vector<Pronostic> pronostics = new Vector<Pronostic>();
	...
	public Vector<Pronostic> getPronostics(){
		return this.pronostics;
	}
	
	public void addPronostic(String desc, double fee) {
		this.pronostics.add(new Pronostic(desc, fee));
	}
